...
class MapFieldMobile extends Component {
    ...
    render() {
        return (
            <>
                <button className="btn btn-secondary" onClick={this.show}>Placer votre pluvio</button>
                <div id="map-field-mobile"></div>
                <div className="container-map-field-buttons">
                    <button className="btn btn-light" onClick={this.cancel}>Annuler</button>
                    <button className="btn btn-primary" onClick={this.valid}>OK</button>
                </div>
            </>
        );
    }
